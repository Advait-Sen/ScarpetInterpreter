...
public class ScarpetEventServer {
    ...
    public ScarpetEventServer() {
        eventHandlers.put("start", new CallbackList(0));
        eventHandlers.put("stop", new CallbackList(0));
    }
    ...
    public void onStart() {
        eventHandlers.get("start").call(Collections::emptyList);
    }

    public void onStop() {
        eventHandlers.get("stop").call(Collections::emptyList);
    }
